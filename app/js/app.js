...
app.config(function($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, ASSETS){
	...
	$stateProvider.
		...
		state('app.cards-view', {
			url: '/cards-view',
			templateUrl: appHelper.templatePath('tables/cards'),
			resolve: {
				deps: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.tables.datatables,
		...
		state('app.employees-view', {
			url: '/employees-view',
			templateUrl: appHelper.templatePath('tables/employees'),
			resolve: {
				deps: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.tables.datatables,
		...
		state('app.roles-view', {
			url: '/roles-view',
			templateUrl: appHelper.templatePath('tables/roles'),
			resolve: {
				deps: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.tables.datatables,
		...
		state('app.customers-view', {
			url: '/customers-view',
			templateUrl: appHelper.templatePath('tables/customers'),
			resolve: {
				deps: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.tables.datatables,
		...
		state('app.deals-view', {
			url: '/deals-view',
			templateUrl: appHelper.templatePath('tables/deals'),
			resolve: {
				deps: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.tables.datatables,
		...
		state('app.devices-view', {
			url: '/devices-view',
			templateUrl: appHelper.templatePath('tables/devices'),
			resolve: {
				deps: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.tables.datatables,
		...
		state('app.transactions-view', {
			url: '/transactions-view',
			templateUrl: appHelper.templatePath('tables/transactions'),
			resolve: {
				deps: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.tables.datatables,
		...
		state('app.merchants-view', {
			url: '/merchants-view',
			templateUrl: appHelper.templatePath('tables/merchants'),
			resolve: {
				deps: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.tables.datatables,
		...
		state('app.stores-view', {
			url: '/stores-view',
			templateUrl: appHelper.templatePath('tables/stores'),
			resolve: {
				deps: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.tables.datatables,
		...
		state('app.cards-upload', {
			url: '/cards-upload',
			templateUrl: appHelper.templatePath('forms/cards-upload'),
			resolve: {
				dropzone: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.forms.dropzone,
		...
		state('app.customers-upload', {
			url: '/customers-upload',
			templateUrl: appHelper.templatePath('forms/customers-upload'),
			resolve: {
				dropzone: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.forms.dropzone,
		...
		state('app.employees-create', {
			...
			templateUrl: appHelper.templatePath('forms/employees-create'),
			resolve: {
				dropzone: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.forms.dropzone,
		...
		state('app.roles-create', {
			url: '/roles-create',
			templateUrl: appHelper.templatePath('forms/roles-create'),
			resolve: {
				dropzone: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.forms.dropzone,
		...
		state('app.devices-create', {
			url: '/devices-create',
			templateUrl: appHelper.templatePath('forms/devices-create'),
			resolve: {
				dropzone: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.forms.dropzone,
		...
		state('app.transactions-upload', {
			url: '/transactions-upload',
			templateUrl: appHelper.templatePath('forms/transactions-upload'),
			resolve: {
				dropzone: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.forms.dropzone,
		...
		state('app.merchants-create', {
			url: '/merchants-create',
			templateUrl: appHelper.templatePath('forms/merchants-create'),
			resolve: {
				dropzone: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.forms.dropzone,
		...
		state('app.stores-create', {
			url: '/stores-create',
			templateUrl: appHelper.templatePath('forms/stores-create'),
			resolve: {
				dropzone: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.forms.dropzone,
		...
		state('app.reports-signups-activations', {
			url: '/reports-signups-activations',
			templateUrl: appHelper.templatePath('charts/signups-activations'),
			resolve: {
				resources: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.charts.dxGlobalize,
		...
		state('app.reports-card-usage', {
			url: '/reports-card-usage',
			templateUrl: appHelper.templatePath('charts/card-usage'),
			resolve: {
				resources: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.charts.dxGlobalize,
		...
		state('app.reports-velocity', {
			url: '/reports-velocity',
			templateUrl: appHelper.templatePath('charts/velocity'),
			resolve: {
				resources: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.charts.dxGlobalize,
		...
		state('app.reports-merchants', {
			url: '/reports-merchants',
			templateUrl: appHelper.templatePath('charts/merchants'),
			resolve: {
				resources: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.charts.dxGlobalize,
