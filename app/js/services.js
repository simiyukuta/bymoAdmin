...
angular.module('xenon.services', []).
	service('$menuItems', function()
	{
		...
		{
			var dashboard    = this.addItem('Dashboard', 		'/app','fa-dashboard');
			var cards      = this.addItem('Cards',	'/app/cards',	'fa-credit-card');
			var customers      = this.addItem('Customers',	'/app/customers',	'fa-users');
			var deals      = this.addItem('Deals',	'/app/deals',	'fa-heart');
			var employees      = this.addItem('Employees',	'/app/employees',	'fa-user');
			var roles      = this.addItem('Roles',	'/app/roles',	'linecons-key');
			var devices      = this.addItem('Devices',	'/app/devices',	'fa-tablet');
			var transactions      = this.addItem('Transactions',	'/app/transactions',	'fa-money');
			var merchants      = this.addItem('Merchants',	'/app/merchants',	'fa-user-md');
			var stores      = this.addItem('Stores','/app/stores',	'linecons-shop');
			var reports      = this.addItem('Reports','/app/reports',	'fa-line-chart');
...
//				dashboard.addItem('Dashboard 3', 	'-/variant-3');
				dashboard.addItem('Main Dashboard', 	'-/dashboard');
				dashboard.addItem('Update Hightlights', '/app/update-highlights').setLabel('v1.3', 'pink');


                                // Subitems of Cards
                                cards.addItem('View Cards',		'-/view');
				cards.addItem('Activations',		'-/upload');
                                // Subitems of Customers
                                customers.addItem('View customers',		'-/view');
				customers.addItem('New Customer',		'-/upload');
                                // Subitems of Deals
                                deals.addItem('View Deals',		'-/view');
                                // Subitems of Employees
                                employees.addItem('View Employees',		'-/view');
				employees.addItem('New Employee',		'-/create');
                                // Subitems of Employees
                                roles.addItem('View Roles',		'-/view');
				roles.addItem('New Role',		'-/create');
                                // Subitems of Devices
                                devices.addItem('View Devices',		'-/view');
				devices.addItem('New Device',		'-/create');
                                // Subitems of Transactions
                                transactions.addItem('View Transations',		'-/view');
				transactions.addItem('New Transaction',		'-/upload');
                                // Subitems of Merchants
                                merchants.addItem('View Merchants',		'-/view');
				merchants.addItem('New Merchant',		'-/create');
                                // Subitems of Merchants
                                stores.addItem('View Stores',		'-/view');
				stores.addItem('New Store',		'-/create');
                                // Subitems of Reports
                                reports.addItem('Signups & Activations',		'-/signups-activations');
				reports.addItem('Card Usage',		'-/card-usage');
				reports.addItem('Velocity',		'-/velocity');
				reports.addItem('Merchant Sales/Transactions & Frequency Report',		'-/merchants');
				reports.addItem('Target Analysis',		'-/target-analysis');
				reports.addItem('Deals Report',		'-/deals-report');
